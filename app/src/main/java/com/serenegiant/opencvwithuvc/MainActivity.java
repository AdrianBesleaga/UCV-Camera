...
//
//
////			buttonPress(ctrlBlock);
//
////			camera.destroy();
//
////			mToolsLayout.setOnKeyListener(new View.OnKeyListener() {
////				@Override
////				public boolean onKey(View view, int i, KeyEvent keyEvent) {
////					final Toast toast = Toast.makeText(MainActivity2.this, "onButton(button)", Toast.LENGTH_SHORT);
////					Log.v(TAG, "button");
////					toast.show();
////					return false;
////				}
////			});
////			mCameraButton.setOnKeyListener(new View.OnKeyListener() {
////				@Override
////				public boolean onKey(View view, int i, KeyEvent keyEvent) {
////					final Toast toast = Toast.makeText(MainActivity2.this, "onButton(button)", Toast.LENGTH_SHORT);
////					toast.show();
...
//	};
//
//	private void buttonPress(final UsbControlBlock ctrlBlock) {
////		queueEvent(new Runnable() {
////			@Override
////			public void run() {
